...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Motorspace kenya',
    "address" TEXT NOT NULL DEFAULT 'Kiambu Road Nairobi Kenya',
    "phone" TEXT NOT NULL DEFAULT '+254 716 884 011',
    "email" TEXT NOT NULL DEFAULT 'motorspaceai.co.ke',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
